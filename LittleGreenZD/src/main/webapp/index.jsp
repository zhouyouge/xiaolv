...
<div class="login layui-anim layui-anim-up">
    <div class="message" style="font-size: 20px">小绿-管理登录</div>
    ...
    <form method="post" class="layui-form" >
        ...
        <hr class="hr15">
        <input value="登   录" lay-submit lay-filter="login" style="width:100%;font-size: 20px;" type="submit" id="loginBtn">
        <hr class="hr20" >
    </form>
</div>
                    ...
                    $.ajax({
                        ...
                        success:function (result) {
                            if (result.result==true && result.flag==4) {
                                alert("登陆成功，欢迎"+userName+"进入小绿管理系统！");
